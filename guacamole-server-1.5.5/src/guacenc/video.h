...
typedef struct guacenc_video {
    ...
    /**
     * The open encoding context from libavcodec
     */
    AVCodecContext* context;

    /**
     * The open format context from libavformat
     */
    ...
    /**
     * The next frame to be written
     */
    AVFrame* next_frame;

    /**
     * The presentation timestamp for the next frame
     */
    int64_t next_pts;

    /**
     * The timestamp of the last frame written
     */
    guac_timestamp last_timestamp;

#ifdef ENABLE_CUDA
    /**
     * Video filter for CUDA processing
     */
    VideoFilter* filter;
#endif
